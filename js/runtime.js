...
function createtime() {
  ...
  var e = new Date("01/01/2024 00:00:00"),
    t = Math.trunc(234e8 + ((now - e) / 1e3) * 17),
    a = (t / 1496e5).toFixed(6),
    o = new Date("01/01/2024 00:00:00"),
  ...
  (c =
    s < 18 && s >= 9
      ? `<div style="font-size:13px;font-weight:bold">本站居然运行了 ${r} 天 ${s} 小时 ${l} 分 ${b} 秒 <i class="fa-solid fa-pen"></i></div>`
      : `<div style="font-size:13px;font-weight:bold">本站居然运行了 ${r} 天 ${s} 小时 ${l} 分 ${b} 秒 <i class="fa-solid fa-pen"></i></div>`),
